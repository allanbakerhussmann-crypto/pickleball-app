...
exports.stripe_createUserConnectLoginLink = exports.stripe_getUserConnectAccountStatus = exports.stripe_createUserConnectAccount = exports.stripe_webhook = exports.stripe_createCheckoutSession = exports.stripe_createConnectLoginLink = exports.stripe_getConnectAccountStatus = exports.stripe_createConnectAccount = void 0;
...
exports.stripe_createUserConnectAccount = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const userData = userDoc.exists ? userDoc.data() : null;
        let accountId = userData === null || userData === void 0 ? void 0 : userData.stripeConnectedAccountId;
        if (!accountId) {
...
// ============================================
exports.stripe_getUserConnectAccountStatus = functions.https.onCall(async (data, context) => {
    var _a, _b, _c;
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Must be logged in');
    }
